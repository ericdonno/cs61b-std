...
2. [PHASE_2DOT5_SPEC.md](../phase-2.5/PHASE_2DOT5_SPEC.md) 与
   [PHASE_2DOT5_BUILD_GUIDE.md](../phase-2.5/PHASE_2DOT5_BUILD_GUIDE.md)，理解 Phase 3 可以依赖的新世界/敌人契约。
3. `PHASE_2DOT5_COMPLETION.md`，以实际实现、测试命令和最终 commit 替换规划假设。
4. [PHASE_2_COMPLETION.md](../phase-2/PHASE_2_COMPLETION.md)，理解更早的 Session 基础设施。
