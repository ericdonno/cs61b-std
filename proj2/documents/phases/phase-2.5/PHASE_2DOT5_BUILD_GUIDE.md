...
4. [PHASE_2_COMPLETION.md](../phase-2/PHASE_2_COMPLETION.md) 的真实交付、命令、偏差和已知限制。
5. [health-pack-requirements.md](../../archive/requirements/health-pack-requirements.md) 的生成、拾取、Agent 隐藏和验收规则。
