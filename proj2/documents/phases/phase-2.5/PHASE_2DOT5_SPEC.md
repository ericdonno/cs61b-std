...
- **前一阶段 Completion**：[PHASE_2_COMPLETION.md](../phase-2/PHASE_2_COMPLETION.md)
- **配套指南**：[PHASE_2DOT5_BUILD_GUIDE.md](PHASE_2DOT5_BUILD_GUIDE.md)
- **后续阶段**：[PHASE_3_SPEC.md](../phase-3/PHASE_3_SPEC.md)
...
- [PHASE_2_COMPLETION.md](../phase-2/PHASE_2_COMPLETION.md)：Phase 2 已交付的异步桥、私有 Observation、reflex、fallback、trace 与已知限制。
- [health-pack-requirements.md](../../archive/requirements/health-pack-requirements.md)：跨层 HP、苹果生成、拾取、存档和 Agent 隐藏规则。
- [PHASE_3_SPEC.md](../phase-3/PHASE_3_SPEC.md) 与 [PHASE_3_BUILD_GUIDE.md](../phase-3/PHASE_3_BUILD_GUIDE.md)：需要改写的前置契约、checkpoint 身份和 intent 迁移假设。
