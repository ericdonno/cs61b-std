...
- [EnemyBrain.java](../../../byog/AI/EnemyBrain.java)：接口返回 `StrategicIntent`，不是 Action 列表
- [ClassicalPlanner.java](../../../byog/AI/ClassicalPlanner.java)：负责 BFS 寻路 + 生成 MoveAction
- [StrategicIntent.java](../../../byog/AI/StrategicIntent.java)：已有 goal、strategy、targetPosition、confidence、targetRoom 字段
...
当前 [GameStateSnapshot.java](../../../byog/AI/GameStateSnapshot.java) 只有4个字段：
