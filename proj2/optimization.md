...
**改动文件**: [Game.java](file:///d:/Courses/cs61b/cs61b-std/proj2/byog/Core/Game.java)、[Position.java](file:///d:/Courses/cs61b/cs61b-std/proj2/byog/lab5/Position.java)（添加 `equals`/`hashCode`）
...
**改动文件**: [Entity.java](file:///d:/Courses/cs61b/cs61b-std/proj2/byog/Core/Entity.java)
...
**改动文件**: [Game.java](file:///d:/Courses/cs61b/cs61b-std/proj2/byog/Core/Game.java)、[EntityManager.java](file:///d:/Courses/cs61b/cs61b-std/proj2/byog/Core/EntityManager.java)
...
**改动文件**: [EntityState.java](file:///d:/Courses/cs61b/cs61b-std/proj2/byog/Core/EntityState.java)（新建）、[Player.java](file:///d:/Courses/cs61b/cs61b-std/proj2/byog/Core/Player.java)（添加 hp/sightRange）、[Game.java](file:///d:/Courses/cs61b/cs61b-std/proj2/byog/Core/Game.java)（save/load）
...
**改动文件**: [Game.java](file:///d:/Courses/cs61b/cs61b-std/proj2/byog/Core/Game.java)
