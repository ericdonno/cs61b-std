...
- [PHASE_2_COMPLETION.md](PHASE_2_COMPLETION.md)：真实交付、测试证据、已知限制和 Phase 3 首要入口。
- [PHASE_2DOT5_SPEC.md](PHASE_2DOT5_SPEC.md)：命名世界、玩家跨层状态、血包、敌人朝向/
  `maxHp`、半菱形 FOV、确定性巡视、Observation v2 与 trace 基线。
- [PHASE_2DOT5_BUILD_GUIDE.md](PHASE_2DOT5_BUILD_GUIDE.md)：Phase 3 开工前的实现顺序与验收门禁。
