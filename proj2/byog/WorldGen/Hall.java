...
public class Hall {
    ...
    boolean addSelf(TETile[][] world, Random random) {
        if (room1.getShape().equals("SQUARE") && room2.getShape().equals("SQUARE")) {
            ...
            boolean isAtPhase6 = room1Left+1 >= room2Right && room2Bottom+1 >= room1Top;  //左上
            boolean isAtPhase7 = room1Left+1 >= room2Right && room1Bottom+1 >= room2Top;  //左下
            boolean isAtPhase8 = room2Left+1 >= room1Right && room1Bottom+1 >= room2Top;  //右下
