...
import byog.Common.RandomUtils;
import byog.Core.Main;
...
import static byog.Common.RandomUtils.biasUniform;
...
public class MathTest {
    ...
    public void testRandomSquareRoomWrd() {
        ...
        for (int i = 0; i < repetitions; i++) {
            ...
            // 生成随机种子，调用方法
            String rawSeed = System.currentTimeMillis() + "" + i;
            char[] charArray = rawSeed.toCharArray();
            RandomUtils.shuffle(new Random(rawSeed.hashCode()), charArray);
